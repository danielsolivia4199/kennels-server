...
from .locations_requests import get_all_locations
from .locations_requests import get_single_location
from .locations_requests import create_location
from .locations_requests import delete_location
from .locations_requests import update_location
