...
class HandleRequests(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        new_employee = None
        new_customer = None
        # Determine the appropriate resource to create
        if resource == "animals":
